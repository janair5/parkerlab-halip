function PrepareStimulus(iTrial, H)
...
StimulusSettings.NoiseColor='WhiteUniform';
...
% disp('### ALERT ### EmbedSignal generated using randomSample to avoid Stats Toolbox. Return to randSample() before production')
...
NoiseAttFactor = GenerateNoise(StimulusSettings, H); % NOTE: With HiFi module, NoiseStream is not used. 
%                                                         Instead, GenerateNoise directly configures the HiFi module's synth function.
SignalStream = GenerateSignal(StimulusSettings, NoiseAttFactor, StimulusSettings.EmbedSignal);
