...
elseif BpodSystem.Data.Custom.EmbedSignal(iTrial) == 1 %none
    StimStartOutput = {'HiFi1',['P' 1]};
    StimStopOutput = {'HiFi1','X'};
end

% NoiseStartOutput = {'SoftCode',21};
% NoiseStopOutput = {'SoftCode',22};
% With HiFi, noise is persistent (controlled by PC). This can be changed to switch it off during inter-trial intervals if necessary
NoiseStartOutput = {};
NoiseStopOutput = {};
...
sma = AddState(sma, 'Name', 'wait_Cin',...
    'Timer', 0,...
    'StateChangeConditions', {CenterPortIn, 'Cin_GraceStart'},... Port2In
